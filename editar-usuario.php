...
<form id="form" action="?page=salvar" method="POST">
    ...
    <div class="mb-3">
        <label>Senha</label>
        <input type="password" id="senha" name="senha" minlength="6" class="form-control" required>
    </div>
    <div class="mb-3">
        <label>Data de Nascimento</label>
        <input type="date" id="data" name="data_nasc" value="<?php print $row->data_nasc;?>" class="form-control">
    </div>
    <div class="mb-3">
        <button type="submit" class="btn btn-primary" >Enviar</button>
    </div>
</form><script src="validacao.js"></script>